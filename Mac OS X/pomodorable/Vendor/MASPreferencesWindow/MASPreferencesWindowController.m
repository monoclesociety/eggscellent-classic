...
- (id)initWithViewControllers:(NSArray *)viewControllers title:(NSString *)title
{
    if ((self = [super initWithWindowNibName:@"MASPreferencesWindow"]))
    {
        ...
        {
            viewController.window = (NSWindow *)self;
        }
...
- (void)setSelectedViewController:(NSViewController <MASPreferencesViewController> *)controller
{
    ...
    NSRect controllerViewBoundsRect = controllerView.bounds;
    controllerViewBoundsRect.size.height = [controller initialHeightOfView];
    NSRect oldViewRect = oldViewRectString ? NSRectFromString(oldViewRectString) : controllerViewBoundsRect;
    NSRect minViewRect = minViewRectString ? NSRectFromString(minViewRectString) : controllerViewBoundsRect;
